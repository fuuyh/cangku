<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="路线描述" prop="describe">
        <el-input
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="行程明细id" align="center" prop="id" />
      <el-table-column label="路线" align="center" prop="route" />
      <el-table-column label="路线描述" align="center" prop="describe" />
      <el-table-column label="排序码" align="center" prop="orderNo" />
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['wh:detail:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['wh:detail:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="detailRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="路线描述" prop="describe">
          <el-input v-model="form.describe" placeholder="请输入路线描述" />
        </el-form-item>
        <el-form-item label="排序码" prop="orderNo">
...
import { listDetail, getDetail, delDetail, addDetail, updateDetail } from "@/api/wh/detail";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除计划行程明细编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('wh/detail/export', {
    ...queryParams.value
